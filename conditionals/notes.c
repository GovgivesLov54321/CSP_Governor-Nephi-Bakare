// Governor-Nephi Bakare, Conditionals Notes C
#include <stdio.h>
...
if(strcmp(name, "Gov") ==0){ //strcmp means string comparison when the outcome is 0 the string are the same
    printf("Hello Gov, welcome to class");
